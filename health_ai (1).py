...
Original file is located at
    https://colab.research.google.com/drive/18wp15Cpn42Yo8VNhHXcPWchnudlwz-xE
"""
...
def disease_prediction(symptoms):
    prompt = f"Based on the following symptoms, provide possible medical conditions and general medication suggestions. Always emphasize the importance of consulting healthcare professionals for diagnosis and treatment.\nSymptoms: {symptoms}"
